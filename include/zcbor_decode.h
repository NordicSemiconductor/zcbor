 ...
 *
 * Note: If this is called on a string started with @ref zcbor_cbor_bstr_fragments_start_decode,
 *       no bytes are consumed from the payload.
 *       Instead, this function reports the part of the current payload section that has
 *       already been decoded via other zcbor functions.
 */
