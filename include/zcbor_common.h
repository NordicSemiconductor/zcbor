...
#define ZCBOR_ERR_TOO_LARGE_FOR_STRING 25 ///! Trying to start a nested string that is too large to fit in the container string.
#define ZCBOR_ERR_NOT_IN_FRAGMENT 26
#define ZCBOR_ERR_INSIDE_STRING 27 ///! Currently encoding/decoding a non-CBOR-encoded string, so cannot use most zcbor encoding/decoding functions
