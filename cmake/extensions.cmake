...
# cddl_generate(<target> <cddl_file> ENTRY_TYPES <entry_types> [VERBOSE])
#
...
function(cddl_generate target cddl_file)
  ...
  target_include_directories(${target} PUBLIC ${h_file_dir} ${CDDL_GEN_BASE}/include)
  target_link_libraries(${target} PRIVATE cbor_decode zephyr_interface)
endfunction(cddl_generate)
